...
<template>
    ...
    >
        ...
        <div class="flex justify-start items-center flex-grow relative gap-2">
            ...
            <p class="flex-grow-0 flex-shrink-0 text-xs text-left text-gray-600">{{ bedroom }}</p>
        </div>
        <div class="flex justify-center items-center flex-grow relative gap-2">
            ...
            <p class="flex-grow-0 flex-shrink-0 text-xs text-left text-gray-600">{{ bathroom }}</p>
        </div>
